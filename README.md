...
- ⚙️ **Automation & Control Systems** (PLC, instrumentation)
...
Low-Voltage Electrical Systems, Component Assembly & Testing, Preventive Maintenance
...
- **PCB & Simulation**: Proteus, EasyEDA, KiCAD  
- **3D Design**: SolidWorks (Basic)  
- **PLC**: CX-Programmer (OMRON)  
- **IoT Development**: Arduino IDE, PlatformIO  
- **Productivity**: MS Excel, PowerPoint, Word
